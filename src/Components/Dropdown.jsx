    ...
    return (
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="w-full flex items-center justify-between py-3 px-4    text-black font-bold hover:bg-gray-100 hover:text-gray-900 rounded-lg transition-colors"
        >
          <span>{title}</span>
          <FiChevronDown
            ...
            <div key={index} className="relative">
              <div className={item.children ? "relative group/submenu" : ""}>
                <Link
                  ...
                  to={item.path || "#"}
                  className="block px-4 py-3 text-black hover:bg-gray-50 hover:text-gray-900"
                >
                   <div className="flex items-center gap-3">
                {item.icon && (
                  <span
                ...
                {item.children && (
                  <div
                    className="absolute left-full top-0 w-60 bg-primary text-black shadow-lg  rounded-lg py-3
