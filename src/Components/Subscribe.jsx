...
const Subscribe = () => {
  ...
  async function handleSubscribe(values) {
    ...
    try {
      ...
      let  data  = await axios.post(`${baseUrl}/subscribes`, values, {
        headers: {
          "X-API-KEY": XApiKey,
      ...
      if (data.data.message === "Subscribe submitted successfully.") {
        setIsSent(true);
      ...
      <div>
        {!isSent && !isErr && !isBot ? (
          <form
            ...
            className="w-full max-w-4xl mx-auto mb-5 rounded-[2rem] bg-gradient-to-r from-green/10 via-primary/30 to-green/10"
          >
            <div className=" rounded-[2rem]      shadow-lg p-2 sm:p-3">
              <div className="flex w-full flex-col gap-3 md:flex-row md:items-center">
                <div className="relative flex-1 min-w-0">
                  <span
                    className={`absolute inset-y-0 flex items-center text-third/80 ${
                  ...
                  <input
                    ...
                    name="email"
                    id="subscribe_email"
                    className={`w-full rounded-full bg-white/5 border border-black text-black placeholder-gray-400 h-12 focus:outline-none focus:ring-2 focus:ring-white/30 ${
                ...
                <div className="relative w-full md:w-56">
                  <input
                    ...
                    type="number"
                    id="ReCapcha"
                    className="w-full rounded-full bg-white/5 border border-black text-black placeholder-gray-400 px-4 h-12 focus:outline-none focus:ring-2 focus:ring-white/30"
                    placeholder={`${
                ...
                <div className="w-full md:w-auto">
                  <button
                    type="submit"
                    className="w-full md:w-48 inline-flex items-center justify-center gap-2 rounded-full h-12 text-white font-bold bg-linear-to-r from-third/80 to-gray-700 hover:from-gray-700 hover:to-third/80 transition-all duration-500"
                  >
        ...
        {isSent ? (
          <div className="text-center text-third py-2 font-bold">
