      ...
      <AnimatePresence mode="wait">
        {submitted ? (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="flex flex-col items-center bg-gradient-to-r from-third/40 to-third text-white rounded-xl justify-center min-h-[220px] p-8 shadow-inner"
          >
          ...
          >
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full max-h-20 px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-base/70 focus:border-transparent outline-none transition-all duration-200 resize-none"
              />
            </div>
